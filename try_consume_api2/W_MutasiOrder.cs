...
{
    public partial class W_MutasiOrder : Form
    {
        ...
        String store_code2, date2, mut_from_war2, mut_to_war2, id_m_o2, req_dev_date2, time2, timestamp2, epy_id, epy_name;
        int id_Mo2, status2, totalqty2;
        //===============================================================================================
        String real_article_id;
        public W_MutasiOrder()
        {
            InitializeComponent();
        }
        ...
        public async Task Post_Mutasi_Order()
        {
            ...
            String sql = "SELECT * FROM mutasiorder WHERE STATUS_API=0";
            ...
            if(ckon1.myReader.HasRows)
            {
                while(ckon1.myReader.Read())
                {
                    ...
                    var json2 = new JavaScriptSerializer().Serialize(mo_new);
                    ...
                    using (var client = new HttpClient(handler))
                    {
                        try
                        {
                            ...
                            HttpResponseMessage message = client.PostAsync("http://mpos.biensicore.co.id/api/MutasiOrder", httpContent).Result;
            ...
            ckon1.con.Close();
            //=================================END IF QUERY HAS DATA===================================================

        }
        //====================================================================================================
        private void W_MutasiOrder_Load(object sender, EventArgs e)
        {
        ...
        {
            API_Mut_Order mut = new API_Mut_Order();
            mut.Post_Mutasi_Order().Wait();
        }
    }
}
