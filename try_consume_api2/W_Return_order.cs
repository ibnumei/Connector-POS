...
{
    public partial class W_Return_order : Form
    {
        ...
        String store_code2, date2, remark2, id_r_o2, time2, timestamp2, warehouseid2;
        int id_Ro2, status2, totalqty2;
        //===============================================================================================
        String real_article_id;
        public W_Return_order()
        {
            InitializeComponent();
        }
        ...
        public async Task Post_Return_Order()
        {
            ...
            String sql = "SELECT * FROM returnorder WHERE STATUS_API=0";
        ...
        //============================================================================================================
        private void W_Return_order_Load(object sender, EventArgs e)
        {
        ...
        {
            //Post_Return_Order().Wait();
            API_ReturnOrder ro = new API_ReturnOrder();
            ro.Post_Return_Order().Wait();
