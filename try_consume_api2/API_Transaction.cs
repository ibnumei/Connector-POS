...
namespace try_consume_api2
{
    class API_Transaction
    {
        ...
        public String st_code2, custid2, date2, employe2, recepid2, spgid2, time2, timestamp2, transid2, cust_id_store2, nm_cur2, bank1, bank2, ref1, ref2, seq_number_substring;
        ...
        public int id_line2, price_line2, qty_line2, sub_line2, trans_lineFk2, discount,  dis_type2;
        ...
        public async Task Post_article()
        {
            ...
            if (ckon1.myReader.HasRows)
            {
                while (ckon1.myReader.Read())
                {
                    ...
                    seq_number_substring = transid2.Substring(12);
                    ...
                    Transaction trans_new = new Transaction()
                    {
                        ...
                        try
                        {
                            HttpResponseMessage message = client.PostAsync(ls.link+"/api/Transaction", httpContent).Result;
                            //HttpResponseMessage message = client.PostAsync("http://mpos.biensicore.co.id/api/Transaction", httpContent).Result;
