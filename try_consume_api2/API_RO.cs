...
namespace try_consume_api2
{
    class API_RO
    {
        ...
        String store_code2, date2, req_dev_date2, req_order_id2, time2, timestamp2, warehouseid2, cust_id_Store, epy_id, epy_name, seq_number_substring, no_sj;
        ...
        public async Task Post_request_order()
        {
            ...
            if (ckon1.myReader.HasRows)
            {
                while (ckon1.myReader.Read())
                {
                    ...
                    seq_number_substring = req_order_id2.Substring(12);
                    ...
                    using (var client = new HttpClient(handler))
                    {
                        try
                        {
                            HttpResponseMessage message = client.PostAsync(ls.link+"/api/RequestOrder", httpContent).Result;
                            //HttpResponseMessage message = client.PostAsync("http://mpos.biensicore.co.id/api/RequestOrder", httpContent).Result;
